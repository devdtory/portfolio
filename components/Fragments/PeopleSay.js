          ...
          >
            <div className="lg:col-span-2 bg-white rounded-lg p-8">
              ...
              <p className="text-[#333] mt-3 text-sm leading-[21px]">
                The team at Dtory does a great job at a great price. I have
                already had two logos, a front-end design and a promotional
                video created by Dtory. At the moment, we are in the process of
                implementing another project together. The team always keeps me
                as a customer up to date with the latest developments of the
                commissioned service and also asks the right questions at the
                right time. Congratulations on your new website and on your
                growth. You are doing a great job. I really enjoy working with
                you. Keep it up!
              </p>
            ...
            <div className="bg-white rounded-lg p-8 flex flex-col">
              ...
              <p className="text-[#333] mt-3 mb-4 text-sm leading-[21px]">
                Very impressive work guys! Working with @Bracie for the past
                week has been amazing and we were so impressed with her patience
                and quality of work. We&apos;ll happily come back anytime soon.
              </p>
            ...
            <div className="bg-white rounded-lg p-8 flex flex-col">
              ...
              <p className="text-[#333] mt-3 mb-4 text-sm leading-[21px]">
                Subhankar from Dtory really did an amazing job! I had a very
                short deadline and he immediately commited to it and came up
                with a real good design solution. beautifully executed! Thanks a
                lot!
              </p>
              <h2 className="text-[#1B1B1B] mt-auto font-semibold text-sm">
                Joan Boixadós
