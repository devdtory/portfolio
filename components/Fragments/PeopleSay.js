        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 px-[20px] lg:px-[100px] gap-5">
          <div className="lg:col-span-2 bg-white rounded-lg p-8">
            ...
            <p className="text-[#333] mt-3 text-sm leading-[21px]">
              ...
              already had two logos, a front-end design and a promotional video
              created by Dtory. At the moment, we are in the process of
              implementing another project together. The team always keeps me as
              a customer up to date with the latest developments of the
