  ...
  return (
    <section className="min-h-[800px] relative font-mona-sans">
      ...
      <div className="absolute inset-0 h-full w-full z-20 pt-[160px] lg:pt-[218px] px-[20px] lg:px-[100px]  ">
        <h1 className="headingGradient font-mona-sans w-fit mx-auto text-[40px] lg:text-[72px] text-center font-bold leading-[50px] lg:leading-[90.36px] relative">
        ...
        <p className="text-white text-center mt-6 leading-[24px] z-30 font-mona-sans">
